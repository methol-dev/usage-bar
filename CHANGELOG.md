...
- **网页用量源生效时图表趋势线断线**：此前历史采样点只在 CLI 渠道拉取时记录，浏览器扩展持续同步时 CLI 不再取数、图表随之停更。现在网页渠道的数据同样会写入本地历史（按扩展同步时刻落点、自动去重），趋势线不再断。（[#53](https://github.com/methol-dev/usage-bar/pull/53)）
- **扩展停摆后图表长时间空窗**：网页数据陈旧（超 1 小时）或同步失败时，app 自动回退到 CLI 渠道取数，两条渠道谁可用用谁；网页渠道正常时仍优先、不打限流端点。（[#53](https://github.com/methol-dev/usage-bar/pull/53)）
- **阈值通知在网页渠道生效期恢复工作**：此前仅 CLI 拉取会触发用量阈值通知，现在网页渠道的数据同样参与阈值检查。（[#53](https://github.com/methol-dev/usage-bar/pull/53)）

### 内部（Internal）

- 历史记点三防线：时间戳取整到秒（ISO8601 落盘丢亚秒）、同时间戳去重（防重启重放与图表身份冲突）、乱序按时序插入；各 provider 的历史采样换算统一到 `HistoryRecording.record`。（[#53](https://github.com/methol-dev/usage-bar/pull/53)）
...
- 版本计划：`docs/versions/v0.7.1-project-audit-hardening.md`
...
- 版本计划：`docs/versions/v0.7.0-update-button-position.md`

---

## [v0.6.0] — 2026-05-15

> spec: `2026-05-13-gemini-provider` · 版本: `v0.6.0`
...
- 版本计划：`docs/versions/v0.6.0-gemini-provider.md`
...
> spec: `2026-05-14-observable-migration` · 版本: `v0.5.3`
...
> spec: `2026-05-14-claude-credentials-in-memory` · 版本: `v0.5.1`
...
> spec: `2026-05-13-docs-cleanup` · 版本: `v0.4.1`
...
> spec: `2026-05-13-view-layer-modernization` · 版本: `v0.4.0`
...
> spec: `2026-05-13-code-structure-hygiene` · 版本: `v0.3.2`
...
> spec: `2026-05-13-swiftui-hygiene` · 版本: `v0.3.1`
...
> spec: `2026-05-13-provider-self-management` · 版本: `v0.3.0`
...
> spec: `2026-05-12-usage-store-redesign` · 版本: `v0.2.3`（supersede v0.1.2 local-cost-scan）
...
- spec: `2026-05-11-sparkle-beta-channel`
- 版本: `v0.2.2`
...
- spec: `2026-05-11-local-cost-scan`
- 版本: `v0.1.2`
...
- 版本计划：`docs/versions/v0.1.1-claude-cli-credentials.md`
- 含 spec：`2026-05-11-claude-cli-credentials`
- 母法：`docs/superpowers/specs/2026-05-11-docs-governance.md`
...
- 版本计划：`docs/versions/v0.1.0-phase1-milestone.md`
...
- 版本计划：`docs/versions/v0.0.11-pace-tracking.md`
...
- 版本计划：`docs/versions/v0.0.10-menubar-display-modes.md`
...
- 版本计划：`docs/versions/v0.0.9-trend-arrows.md`
...
- 版本计划：`docs/versions/v0.0.8-hero-popover.md`
...
- 版本计划：`docs/versions/v0.0.7-docs-governance.md`
