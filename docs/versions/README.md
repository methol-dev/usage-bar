...
| [v0.2.10](./v0.2.10-settings-provider-list.md) | settings-provider-list | planned | 2026-05-16 | ⚙️ Settings 改 provider 列表（拖动排序 + 启用开关 + 菜单栏单选子开关）+ 去 Account 区 + Codex 统一 polling interval + 刷新纪律（切 tab 不刷新；刷新只 2 入口）|
